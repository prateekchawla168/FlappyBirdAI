...
SCREENWIDTH  = 288
SCREENHEIGHT = 512
# Max mount by which base can shift to left
...
def main():
    ...
    pygame.init()
    pygame.display.set_icon(pygame.image.load('flappy.ico')) # Set Icon
    FPSCLOCK = pygame.time.Clock()
    SCREEN = pygame.display.set_mode((SCREENWIDTH, SCREENHEIGHT))
    pygame.display.set_caption('Flappy Bird AI Bot v2.1')
...
def ShowWelcomeAnimation():
    ...
    while True:
        ...
        ''' # Unreachable code. Uncomment in case you want the keypress functionality restored. 
    ...
    while True:
        ...
        for pipe in upperPipes:
            ...
            if pipeMidPos <= playerMidPos < pipeMidPos + 4:
                score += 1
                bot.setBotScore(score) # Update bot score after each point
                SOUNDS['point'].play()
